        ...
        <div class="accordion" id="accordionPanelsStayOpenExample">
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Tidak, Maniac XII berfokus pada bidang multimedia. Bidang akademis hanya akan diuji di beberapa pos
                        pada rally games.
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        MANIAC hanya berfokus pada 2 bidang Multimedia, yaitu <i>Game Concept Design</i> dan <i>Game Asset
                            Design</i>
                    </div>
                </div>
            </div>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Ya, akan ada Workshop Game Concept & Asset Design pada tanggal 7 Agustus 2023 untuk membekali peserta dengan pengetahuan yang dapat digunakan dalam tahap pengerjaan final.
                    </div>
                </div>
            </div>
            <br>
                ...
                <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8"
                    ...
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Pendaftaran dilakukan secara online dengan mengisi form pendaftaran yang tersedia di website <a
                            href="https://maniacubaya.com">maniacubaya.com</a>
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="accordion-item faq-radialGradient">
                <h2 class="accordion-header" id="heading10">
                    <button class="accordion-button collapsed color-title-faq faq-radialGradient-title" type="button"
                        ...
                        Apakah workshop diwajibkan bagi semua peserta lomba Maniac XII?
                    </button>
                </h2>
                <div id="collapse10" class="accordion-collapse collapse" aria-labelledby="heading10"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Ya, diwajibkan agar peserta memiliki pembekalan yang cukup untuk pengerjaan final serta setelah workshop akan diadakan technical meeting untuk babak penyisihan. Selain itu Workshop juga akan terbuka untuk umum secara berbayar.
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="accordion-item faq-radialGradient">
                ...
                <div id="collapse22" class="accordion-collapse collapse" aria-labelledby="heading22"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body color-inside-faq faq-radialGradient-inside">
                        Tidak ada pengurangan nilai, anggota tim yang tersisa dapat tetap mengikuti rangakaian acara MANIAC XII 
                        dengan catatan ada beberapa rally games yang tidak dapat dimainkan dan anggota tim yang tidak hadir tidak dapat 
